...
In order to install and run the project on your local environment we recommend to follow the [user installation manual](https://github.com/angelonazzaro/OpenMeet/blob/main/deliverables/openMeet_MDI.pdf). 
