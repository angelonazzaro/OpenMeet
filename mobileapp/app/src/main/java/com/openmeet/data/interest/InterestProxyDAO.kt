...
class InterestProxyDAO(context: Context) : ContextDAO(context), DAO<Interest> {
    ...
    override fun doRetrieveByCondition(condition: String, rows_count: Int): MutableList<Interest>? {
    ...
    override fun doRetrieveByCondition(condition: String, offset: Int, rows_count: Int): MutableList<Interest>? {
