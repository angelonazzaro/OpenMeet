...
public class Meeter_InterestProxyDAO extends ProxyDAO<Meeter_Interest> implements DAO<Meeter_Interest> {
    ...
    public List<Meeter_Interest> doRetrieveByCondition(String condition, int row_count) throws SQLException {
        ...
        logger.log(Level.INFO, "Meeter_InterestProxyDAO:doRetrieveByCondition() - condition: " + condition + " LIMIT " + row_count);

        List<Meeter_Interest> meeter_interests = GenericProxyDAO.genericProxyDoRetrieveByCondition(condition, 0, row_count, dao, out);
